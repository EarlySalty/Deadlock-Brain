...
external_id: "data/changelogs/versions/2024-06-06"
canonical_name: "2024-06-06"
snapshot_id: 40834
source_document_id: 7338
payload_hash: "f43b74bc73611a0286bc4d5236ee2ed0e387ce9a8e8da13ec261f0662f9b6913"
source_content_hash: "fd77c18d31eb1c39bccf0b4b31e98073b2ca31006a8158bfb72def17a6c39111"
source_url: "https://github.com/deadlock-wiki/deadlock-data/blob/e3fb36ebbb046e73c44a37ecb31e3e096bfc7a06/data/changelogs/versions/2024-06-06.json"
source_raw_path: "data/raw/deadlock_data/data_changelogs_versions_2024-06-06.json.fd77c18d31eb1c39.json"
fetched_at: "2026-07-09T19:36:26.077672+00:00"
...
- External ID: `data/changelogs/versions/2024-06-06`
- Snapshot ID: `40834`
- Source-Dokument: `7338`
- Kurzinfo: 2024-06-06 aus `deadlock_data` / `patchnote_structured` mit vollstaendiger Payload.
...
````json
{
  "_deadlock_data": {
    ...
    "file_path": "data/changelogs/versions/2024-06-06.json",
  ...
  "events": [
    ...
    {
      "Description": "* {{PageRef|Souls|alt_name=Soul}} Shredder Bullets: Spirit Amp reduced from +12% to +10%",
      "Tags": [
        "Souls",
        "Item"
      ]
    ...
    {
      "Description": "* Improved Cooldown: HP Regen reduced from 2 to 1.5",
      "Tags": [
        "Item"
      ]
    },
    ...
    {
      "Description": "* Curse: No longer prevents stamina usage",
      "Tags": [
        "Item"
      ]
    },
    {
      "Description": "* Curse: Now also prevents item usage",
      "Tags": [
        "Item"
      ]
    },
    {
      "Description": "* Curse: Duration reduced from 3.75s to 3.5s",
      "Tags": [
        "Item"
      ]
    },
