...
git ls-files -z architecture/migration/s12 rust/crates/dbrain-wiki rust/crates/brain-contracts rust/crates/dbrain-sources rust/Cargo.toml rust/Cargo.lock |
